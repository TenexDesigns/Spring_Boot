...
2. **Enable Validation in Spring Boot**:
   By default, Spring Boot auto-configures validation support.
However, you need to ensure that your Spring Boot application has the appropriate validation starter dependencies. 
The starter module includes validation-related configurations.

   If you're using Spring Boot's starter parent, it will include validation by default.
If you're manually managing your dependencies, ensure you have the relevant starters like `spring-boot-starter-validation`.
